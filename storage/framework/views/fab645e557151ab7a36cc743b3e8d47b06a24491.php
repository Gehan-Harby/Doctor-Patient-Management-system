...
unset($__errorArgs, $__bag); ?>
	...
	<div class="row">
          ...
          <div class="col-75">
            <input type="text" id="pnumber" name="num" required placeholder="Patient Phone Number.." minlength="11" maxlength="11">
          </div>
        </div>
        <br>
		<div class="row">
...
<input type="radio" id="gender" name="gender" value="male">Male</div>
 ...
 </html><?php /**PATH C:\Users\20128\Downloads\Final Larvel Project\my_website\resources\views/new_Patient.blade.php ENDPATH**/ ?>
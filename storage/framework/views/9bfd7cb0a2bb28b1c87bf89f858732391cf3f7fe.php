...
<html lang="en">
 ...
 <?php echo $__env->make('navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
    <div class="container">
        <form action="/Perscription" method="post">
            ...
            <div class="row">
              <div class="col-25">
                <label for="vistnum">Vist Number:</label>
              </div>
              <div class="col-75">
                <input type="text" id="vistnum" name="vistnum" required placeholder=" Enter vist number..">
              </div>
            </div>
			      <br>
        <div class="row">
          ...
          <div class="col-75">
            <input type="text" id="fname" name="firstname" required placeholder=" first name of doctor..">
          </div>
        </div>
        <br>
        <div class="row">
          ...
          <div class="col-75">
            <input type="text" id="lname" name="lastname" required placeholder=" name of patient..">
          </div>
        </div>
		...
		<div class="row">
          ...
          <div class="col-75">
            <input type="text" id="email" name="email" required placeholder=" Enter Diagnosis And Treatement..">
          </div>
        </div>
        <br>
        <div class="row">
 ...
 </html><?php /**PATH C:\Users\SaLmA\Downloads\my_website\resources\views/Perscription.blade.php ENDPATH**/ ?>